...
TRASH_LIST = [
    ...
    {"name": "{user}(이)가 먹고 버린 찌그러진 빈 캔", "min_rate": 0.01, "max_rate": 0.05, "group": 1},
    {"name": "{user}의 X가 쓴 찢어진 콘돔", "min_rate": 0.01, "max_rate": 0.05, "group": 1},
    {"name": "축축한 동전 주머니", "min_rate": 0.01, "max_rate": 0.05, "group": 1},
    {"name": "{user}(이)가 먹다만 핫바", "min_rate": 0.01, "max_rate": 0.05, "group": 1},
    ...
    {"name": "헉.. {user}의 니플 집게", "min_rate": 0.08, "max_rate": 0.10, "group": 3},
    ...
    {"name": "{user}(이)가 쓰다 버린 딜도", "min_rate": 0.10, "max_rate": 0.13, "group": 4},
    ...
    {"name": "{user}(이)가 거울보고 내지른 욕", "min_rate": 0.14, "max_rate": 0.20, "group": 5},
    ...
    {"name": "{user}의 분노", "min_rate": 0.01, "max_rate": 0.03, "group": 6},
    {"name": "{user}의 절규", "min_rate": 0.0, "max_rate": 0.0, "group": 6},
