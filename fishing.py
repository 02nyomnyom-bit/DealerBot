...
TRASH_LIST = [
    ...
    {"name": "당신이 먹고 버린 찌그러진 빈 캔", "min_rate": 0.01, "max_rate": 0.05, "group": 1},
    {"name": "당신의 X가 쓴 찢어진 콘돔", "min_rate": 0.01, "max_rate": 0.05, "group": 1},
    {"name": "축축한 동전 주머니", "min_rate": 0.01, "max_rate": 0.05, "group": 1},
    {"name": "당신이 먹다만 핫바", "min_rate": 0.01, "max_rate": 0.05, "group": 1},
    ...
    {"name": "헉.. 당신의 니플 집게", "min_rate": 0.08, "max_rate": 0.10, "group": 3},
    ...
    {"name": "당신이 쓰다 버린 딜도", "min_rate": 0.10, "max_rate": 0.13, "group": 4},
    ...
    {"name": "당신이 거울보고 내지른 욕", "min_rate": 0.14, "max_rate": 0.20, "group": 5},
    ...
    {"name": "당신의 분노", "min_rate": 0.01, "max_rate": 0.03, "group": 6},
    {"name": "당신의 절규", "min_rate": 0.0, "max_rate": 0.0, "group": 6},
        ...
        async with user_locks[self.user.id]:
            ...
            try:
                ...
                if random.random() < trash_chance:
                    ...
                    # 🎁 [수정] 특수 아이템 정산 처리
                    if trash["name"] == "당신의 분노":
                        actual_fine = calculated_fine
                    elif trash["name"] == "당신의 잔소리":
                        actual_fine = 0
                    else:
