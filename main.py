...
class EnhancedBot(commands.Bot):
    ...
    async def update_daily_status(self):
        ...
        status_text = f"📅{date_str} | {greeting} | (v1.10.10)"
        ...
        if guild.id not in Config.MAIN_GUILD_IDS:
            ...
            try:
                if guild.system_channel:
                    ...
                    embed.set_footer(text="보석상 v1.10.10 - 서버 제한 시스템")
    ...
    async def on_ready(self):
        ...
        print("=" * 50)
        print("🎉 보석상 v1.10.10 구동 중 (60초 후 명령어 동기화 예정)")
...
async def main():
    ...
    try:
        logger.info("🚀 보석상 v1.10.10 서버 제한 + 퇴장 로그 + 향상된 업데이트 시스템 시작 중...")
